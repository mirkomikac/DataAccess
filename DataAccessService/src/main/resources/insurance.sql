...
insert into vrednostatributaosiguranja(id, vrednost, osiguranje_id, tipAtributa_id) values(6, 'Ne bavi se sportom', 1, 6);
insert into vrednostatributaosiguranja(id, vrednost, osiguranje_id, tipAtributa_id) values(7, '30.000 EUR', 1, 7);
insert into vrednostatributaosiguranja(id, vrednost, osiguranje_id, tipAtributa_id) values(8, 'Marko', 1, 8);
insert into vrednostatributaosiguranja(id, vrednost, osiguranje_id, tipAtributa_id) values(9, 'Kljajic', 1, 9);
insert into vrednostatributaosiguranja(id, vrednost, osiguranje_id, tipAtributa_id) values(10, '2402994800100', 1, 10);
